...
import roman.vertx.web.handler.HandlerMethodMappingNamingStrategy;

/**
 * A
 * {@link org.springframework.web.servlet.handler.HandlerMethodMappingNamingStrategy
 * HandlerMethodMappingNamingStrategy} for {@code RequestMappingInfo}-based
...
public class RequestMappingInfoHandlerMethodMappingNamingStrategy implements HandlerMethodMappingNamingStrategy<RequestMappingInfo> {
	...
	/**
	 * Separator between the type and method-level parts of a HandlerMethod
	 * mapping name
	 */
